...
function setup() {
  ...
  button_2.position(width/2,30);
  button_2.size(50,50);
  button_2.mouseClicked(drop2);

  button_3 = createImg('cut_btn.png');
  button_3.position(width/2+30,150);
  button_3.size(50,50);
  ...
  rope = new Rope(8,{x:width/2-380,y:30});
  rope2 = new Rope(7,{x:width/2+20,y:30});
  rope3 = new Rope(4,{x:width/2+50,y:150});
